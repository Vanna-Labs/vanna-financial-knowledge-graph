...
Commands follow the syntax defined in zomma_kg/skills/kg-query/SKILL.md:
...
def create_server(name: str = "zomma-kg") -> FastMCP:
    ...
    async def kg_execute(command: str) -> str:
        """
        Execute a ZommaKG knowledge graph command.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="ZommaKG MCP Server",
