...
The current VannaLabsKG system uses Neo4j Aura as its graph database, which presents significant barriers to the project's goal of becoming a pip-installable Python library with zero infrastructure requirements.
...
1. User runs `from vanna import KnowledgeGraph` - instant
